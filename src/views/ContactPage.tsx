  ...
  return (
    <div className="space-y-20 pt-28 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        {/* Left: Contact Form */}
        <div className="lg:col-span-7 bg-[#0E0E12] border border-[#22222A] p-8 rounded-sm space-y-6 shadow-2xl">
          <h3 className="font-serif text-2xl text-[#E8E6E1]">Inquiry & Swatch Box Dispatch</h3>

          {formSubmitted ? (
            <div className="p-8 bg-[#14141C] border border-[#8B1E24]/50 rounded text-center space-y-4">
              <CheckCircle2 className="w-12 h-12 text-[#8B1E24] mx-auto" />
              <h4 className="font-serif text-xl text-[#E8E6E1]">Inquiry Dispatched Successfully</h4>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  <label className="text-[#A09D96] block uppercase font-mono text-[10px]">
                    Full Name *
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full bg-[#14141C] border border-[#262634] rounded p-3 text-[#E8E6E1] placeholder-[#615F59] focus:outline-none focus:border-[#8B1E24]"
                  />
                </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full bg-[#14141C] border border-[#262634] rounded p-3 text-[#E8E6E1] focus:outline-none focus:border-[#8B1E24]"
                  >
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-[#0E0E12] border border-[#22222A] p-6 rounded-sm space-y-4">
            <h4 className="font-serif text-xl text-[#E8E6E1] border-b border-[#1C1C24] pb-3">
              Corporate Headquarters
            </h4>

            <div className="space-y-4 text-xs text-[#A09D96]">
              <div className="flex items-start gap-3">
                <MapPin className="w-4 h-4 text-[#8B1E24] shrink-0 mt-0.5" />
                <div>
                  <span className="text-[#E8E6E1] font-semibold block">Mayur Uniquoters Limited</span>
          ...
          <div className="bg-[#0E0E12] border border-[#22222A] p-6 rounded-sm space-y-4">
            ...
            <div className="space-y-3 text-xs text-[#A09D96]">
              <div>
                <span className="text-[#E8E6E1] font-semibold block">Automotive OEM Division:</span>
                <span className="font-mono text-[11px]">auto.oem@mayur.biz</span>
              </div>
              <div>
                <span className="text-[#E8E6E1] font-semibold block">International Exports & Distribution:</span>
                <span className="font-mono text-[11px]">exports@mayur.biz</span>
              </div>
              <div>
                <span className="text-[#E8E6E1] font-semibold block">Investor Relations:</span>
