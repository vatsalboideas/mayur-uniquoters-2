    ...
    <div className="space-y-28 pt-28 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="p-8 bg-[#FFFFFF] border border-[#E0DDD6] rounded-sm space-y-4">
          ...
          <h3 className="font-serif text-2xl text-[#1C1B19]">Zero Liquid Discharge (ZLD)</h3>
        ...
        <div className="p-8 bg-[#FFFFFF] border border-[#E0DDD6] rounded-sm space-y-4">
          ...
          <h3 className="font-serif text-2xl text-[#1C1B19]">Solvent Recovery System</h3>
          <p className="text-xs text-[#6B6860] leading-relaxed">
        ...
        <div className="p-8 bg-[#FFFFFF] border border-[#E0DDD6] rounded-sm space-y-4">
          ...
          <h3 className="font-serif text-2xl text-[#1C1B19]">Solar Energy Integration</h3>
          <p className="text-xs text-[#6B6860] leading-relaxed">
        ...
        <div className="p-8 bg-[#FFFFFF] border border-[#E0DDD6] rounded-sm space-y-4">
          ...
          <h3 className="font-serif text-2xl text-[#1C1B19]">Bio-Based Polyurethane</h3>
          <p className="text-xs text-[#6B6860] leading-relaxed">
        ...
        <div className="p-8 bg-[#FFFFFF] border border-[#E0DDD6] rounded-sm space-y-4">
          ...
          <h3 className="font-serif text-2xl text-[#1C1B19]">REACH & OEKO-TEX Compliance</h3>
          <p className="text-xs text-[#6B6860] leading-relaxed">
